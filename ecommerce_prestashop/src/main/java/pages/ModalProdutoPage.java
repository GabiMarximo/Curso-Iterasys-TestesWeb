...
public class ModalProdutoPage {
	...
	private By descricaoPruduto = By.className("product-name");
	...
	public String obterDescricaoProduto1() {
		return driver.findElement(descricaoPruduto).getText();
	}
	...
	public void obterDescricaoProduto() {
		driver.findElement(descricaoPruduto).getText();
	}
